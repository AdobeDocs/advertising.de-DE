...
* *[!UICONTROL Propagate rows that meet certain conditions:]* So übertragen Sie Daten nur für Zeilen, die bis zu zehn angegebene Bedingungen erfüllen. Angeben der anzuwendenden Filter:
  ...
  Wenn Sie beispielsweise die Spalte „product_type“ auswählen und nur Zeilen für Produktnamen zurückgeben möchten, die „Schuhe“ enthalten, wählen Sie &quot;**[!UICONTROL contains]**&quot; aus und geben Sie `shoes` in das Eingabefeld ein.
