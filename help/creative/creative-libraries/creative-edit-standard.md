...
Sie können einige Einstellungen für jeden Kreativtyp bearbeiten. Sie können mehrere Kreative desselben Kreativtyps (HTML5 mit nur einer Landingpage, HTML5 mit mehreren Landingpages, HTML5 mit flexiblem Design, Bild oder Drittanbieter) bearbeiten.
...
Wenn Sie ein Kreativ bearbeiten, das in einem Bundle enthalten ist, werden Ihre Änderungen automatisch auf alle Erlebnisse angewendet, die das Bundle enthalten. Ausnahme ist, dass alle benutzerdefinierten Landingpages und Tracking-URLs, die auf Erlebnisebene angegeben wurden, für das Bundle, das an dieses Erlebnis angehängt ist, weiterhin gelten.
...
1. Bearbeiten Sie die [Image-Kreativeinstellungen](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-image), [HTML5-Kreativeinstellungen](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-html5), [flexible HTML5-Kreativeinstellungen](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-flexible-html5) oder [Kreativeinstellungen von Drittanbietern](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-third-party).
