...
Sie können eine KI-gestützte Abfrage für alle [!DNL Creative] und (Advertiser mit Advertising DSP) [!DNL DSP] der -Dokumentation senden oder ein vollständiges Benutzerhandbuch für [!DNL Creative] öffnen. Wenn die Dokumentation Ihre Fragen nicht beantwortet, kontaktieren Sie uns.

## Suchen nach Informationen über eine KI-gestützte Chat-Oberfläche

Siehe &quot;[Suchen nach Produktdokumentation mithilfe einer KI-unterstützten Chat-Oberfläche](/help/dsp/agent-chat.md)&quot;.

## Vollständiges Benutzerhandbuch öffnen

Um ein vollständiges Benutzerhandbuch zu öffnen, in dem die Verwendung aller Funktionen erklärt wird, klicken Sie im Hauptmenü auf **[!UICONTROL Help]** und öffnen Sie das Kapitel &quot;[!DNL Creative]&quot;.
