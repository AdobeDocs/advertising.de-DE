...
1. Wählen Sie den Kreativ-Rotationstyp aus:
   ...
   * ** *Gewichtete* ** - Dreht die Kreativen manuell entsprechend der relativen Gewichtung. Geben Sie die Gewichtung für jeden Kreativen in Prozent ein. Die Gewichtungen aller ausgewählten Kreativen müssen bis zu 100 betragen.

   * ** *Algorithmisch* ** - Dreht die Kreativen algorithmisch entsprechend einem angegebenen Optimierungsziel.
