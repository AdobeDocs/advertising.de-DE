---
title: Ändern des Status  [!DNL Google Ads]  Konversionswertregel
description: Erfahren Sie, wie Sie den Status  [!DNL Google Ads]  Konversionswertregeln ändern.
...
# Ändern des Status einer [!DNL Google Ads] Konversionswertregel
