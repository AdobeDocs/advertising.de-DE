...
+ (Beta) NEUE BENUTZEROBERFLÄCHE {#new-ui}
   ...
   + Berichte {#reports}
      + Klassifizierungen kennzeichnen {#label-classifications}
         + [Über Kennzeichnungsklassifizierungen](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about)
