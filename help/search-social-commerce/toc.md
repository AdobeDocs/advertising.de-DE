...
+ (Beta) NEUE BENUTZEROBERFLÄCHE {#new-ui}
   ...
   + Verwalten {#manage}
      ...
      + Kampagnen {#campaigns}
         ...
         + [Anzeigen eines Leistungsdiagramms in der [!UICONTROL Campaigns]](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-performance-graph.md)
      ...
      + Anzeigengruppen {#ad-groups}
         ...
         + [Anzeigen eines Leistungsdiagramms in der [!UICONTROL Ad Groups]](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-view-performance-graph.md)
