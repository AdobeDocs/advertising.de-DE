...
* **[!UICONTROL Manage]** Untermenü:
   ...
   * **[!UICONTROL Portfolio Groups]:** Beendet die neue Site der Benutzeroberfläche und öffnet die Legacy-[!UICONTROL Search, Social, & Commerce] > [!UICONTROL Optimization] > [!UICONTROL Portfolios] > Registerkarte [!UICONTROL Portfolio Groups] .
...
* Klicken Sie über dem Hauptmenü auf der linken Seite auf ![Reduzieren/Erweitern](/help/search-social-commerce/assets/collapse-expand.png "Reduzieren/Erweitern").
...
Die Option [!UICONTROL Search] umfasst die folgenden Untermenüs. Ihre Rolle bestimmt Ihre verfügbaren Optionen:
