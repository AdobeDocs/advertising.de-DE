...
Das Adobe Account Team, das Agency Team oder der Advertiser (je nach den Bedingungen der service level agreement) müssen die Performance jeder Kampagne und jedes Portfolios (falls zutreffend) überwachen und die relevanten Komponenten und Einstellungen nach Bedarf ändern, um die Ziele des Advertisers zu erreichen.
