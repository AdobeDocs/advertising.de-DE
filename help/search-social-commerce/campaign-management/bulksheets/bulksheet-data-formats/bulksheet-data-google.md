...
| [!UICONTROL Ad Group Type] | <p>Der Anzeigengruppentyp: <i>[!UICONTROL Discovery]</i> (nur für Discovery-Kampagnen), <i>[!UICONTROL Display]</i> (für Display-Kampagnen), <i>[!UICONTROL Search Dynamic]</i> (für erweiterte dynamische Suchanzeigen), <i>[!UICONTROL Search Standard]</i> (für Suchanzeigen), <i>[!UICONTROL Shopping Product]</i> (für Shopping-Produktanzeigen), <i>[!UICONTROL Shopping Showcase]</i> (Erstellung und Bearbeitung wird nicht unterstützt) oder <i>[!UICONTROL Unknown]</i>.</p> |
