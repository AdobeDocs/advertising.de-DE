...
| [!UICONTROL Exemption Request] | (In generierten Bulksheets zu Informationszwecken enthalten) Platzhalter zur Anzeige der Namen und des Textes von [!DNL Google Ads] Werberichtlinien, gegen die eine Anzeige verstößt. |
...
| [!UICONTROL Description Line 1]-[!UICONTROL Description Line 2] | Erforderlich, um eine Anzeige zu erstellen oder die Beschreibung zu bearbeiten. <b>Hinweis:</b> Bei diesem Anzeigentyp löscht das Ändern der Anzeigenkopie die vorhandene Anzeige und erstellt eine neue. |
...
| [!UICONTROL Ad Group Name] | Erforderlich |
| [!UICONTROL Max CPC] | Optional |
| [!UICONTROL Auto Target Expression] | Nur erforderlich, wenn die Kampagneneinstellung auf &quot;[!UICONTROL Use my website contents to target my ads]&quot; ist nicht aktiviert. |
