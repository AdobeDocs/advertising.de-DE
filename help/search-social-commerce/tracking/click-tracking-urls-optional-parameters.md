...
| <code>{ef_adid}</code> | So fügen Sie die Werbe-ID ein. <b>Hinweis:</b> Die ID für eine neue Anzeige wird erst erstellt, wenn die Anzeige im Werbenetzwerk gepostet wurde. Wenn das Konto die Optionen &quot;[!UICONTROL EF Redirect]&quot; und &quot;[!UICONTROL Auto Upload]&quot; verwendet, fügt Adobe Advertising die Anzeigen-ID am nächsten Tag automatisch in die entsprechenden Ziel-URLs oder endgültigen URLs ein. Wenn das Konto nicht die Optionen &quot;[!UICONTROL EF Redirect]&quot; und &quot;[!UICONTROL Auto Upload]&quot; verwendet und Sie die Anzeigen-ID in die entsprechenden Ziel-URLs oder endgültigen URLs einfügen möchten, müssen Sie die Anzeige erstellen, eine Bulksheet-Datei für die neue Anzeige herunterladen und die Option zum Generieren von Tracking-URLs verwenden und die Datei dann im Anzeigennetzwerk posten. |
...
>[!MORELIKETHIS]
>
>* [Über Klick-Tracking-URL-Formate für den Konversionsverfolgungs-Service von Adobe Advertising](/help/search-social-commerce/tracking/formats-click-tracking-about.md)
