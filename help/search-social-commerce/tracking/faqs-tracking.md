...
+++ Wie weiß ich, welche Transaktionseigenschaft von einem Daten-Feed stammt oder vom Adobe Advertising Conversion Tracking-Tag verfolgt wird?

In [!UICONTROL Transaction Report]können Sie feststellen, ob eine enthaltene Transaktionseigenschaft vom Adobe Advertising Conversion Tracking-Pixel verfolgt wurde, wenn Sie die benutzerdefinierte Spalte &quot;[!UICONTROL Tracking URL].&quot; Tracking-URLs mit dem Adobe Advertising-Tracking-Pixel beginnen mit `http://pixel.everesttech.net`.
+++
