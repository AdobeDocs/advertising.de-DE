...
Mit der [!UICONTROL Reports] unter [!UICONTROL Search] > [!UICONTROL Insights & Reports] > [!UICONTROL Reports] können Sie Berichte, Vorlagen und Tabellen-Feeds erstellen und verwalten. Die Ansicht enthält zwei Registerkarten:
