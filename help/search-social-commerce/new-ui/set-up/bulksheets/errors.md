---
title: (Neue Benutzeroberfläche) Bulksheet-Fehler
...
# (Neue Benutzeroberfläche) Bulksheet-Fehler
...
* **EF-Fehler** Wenn der Bulksheet-Vorgang keine Datei oder einzelne Zeilen in der Datei hochladen oder verarbeiten kann, wird eine Fehlerdatei mit dem Namen `<uploaded file name>_ef_errors.<extension used for the bulksheet>` erstellt. Wenn das Problem bei einzelnen Zeilen besteht, werden diese Zeilen mit einer Erklärung für jeden Fehler eingeschlossen, damit Sie ihn korrigieren können. Die Fehler sind in der Spalte &quot;[!UICONTROL EF Error Message]&quot; enthalten.
