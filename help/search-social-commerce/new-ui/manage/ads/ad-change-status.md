---
title: (Neue Benutzeroberfläche) Ändern des Status einer Anzeige
description: Erfahren Sie, wie Sie den Status einer Anzeige ändern, ohne die Anzeigeneinstellungen zu öffnen.
...
# (Neue Benutzeroberfläche) Ändern des Status einer Anzeige
