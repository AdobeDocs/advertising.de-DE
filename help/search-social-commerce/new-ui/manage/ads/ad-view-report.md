---
title: (Neue Benutzeroberfläche) Verwalten von Datenansichtsberichten aus der [!UICONTROL Ads]
description: Erfahren Sie, wie Sie Berichte erstellen, herunterladen und löschen, die die Datenzeilen für eine oder mehrere Anzeigen in der Ansicht [!UICONTROL Ads] enthalten.
...
# (Neue Benutzeroberfläche) Verwalten von Datenansichtsberichten aus der [!UICONTROL Ads]

*Beta-Funktion*

Sie können einen Bericht generieren, der die Datenzeilen für eine oder mehrere Anzeigen in der [!UICONTROL Ads] enthält, und dann den Bericht als Excel-Arbeitsblattdatei für Microsoft herunterladen (XLXS-Format). Der Bericht enthält alle sichtbaren Spalten in der Ansicht.
...
>[!MORELIKETHIS]
>
>* [(Neue Benutzeroberfläche) Über die [!UICONTROL Ads view]](ad-view-about.md)
