---
title: (Neue Benutzeroberfläche) Ändern des Status einer Kampagne
description: Erfahren Sie, wie Sie den Status einer Kampagne ändern, ohne die Kampagneneinstellungen zu öffnen.
...
# (Neue Benutzeroberfläche) Ändern des Status einer Kampagne
...
>[!MORELIKETHIS]
>
>* [Über die [!UICONTROL Campaigns] Ansicht](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-about.md)
