...
* *[!UICONTROL Manual CPC]*: (Shopping-Kampagnen für Marken und [!DNL Microsoft Store Ads]) Verwendet das Cost-Per-Click-Modell (CPC). Bei einigen Anzeigentypen können Sie dem Anzeigennetzwerk optional erlauben, Angebote für die Kampagne zu ändern:
...
**[!UICONTROL Local Inventory Ads]:** (Nur Shopping-Netzwerk-Kampagnen) Ermöglicht dem Werbenetzwerk das automatische Hinzufügen Ihrer lokalen Inventarinformationen zu Ihren Shopping-Anzeigen.

**Tipp:** Wenn Sie diese Einstellung verwenden, schließen Sie lokale Anzeigen in der [!UICONTROL Inventory Filter] nicht aus.

**Hinweis:** Für lokale Inventaranzeigen sind zwei zusätzliche Feeds für Ihr Händlerkonto erforderlich - eine für Ihre lokalen Produktdaten und eine weitere für Ihr lokales Produktinventar. Weitere Informationen zu (lokalen [) finden Sie in der [!DNL Microsoft Advertising]-](https://help.ads.microsoft.com/#apex/ads/en/60055).
