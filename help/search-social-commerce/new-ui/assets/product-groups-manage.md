...
1. Klicken Sie bei Bedarf auf ![Bearbeiten](/help/search-social-commerce/assets/edit-new.png "Bearbeiten") **[!UICONTROL Edit]** und ändern Sie die [Google Ads-](#google-ads-product-group-settings) oder [Microsoft Advertising-](#microsoft-advertising-product-group-settings).
