...
#### Portfolio- und Anzeigennetzwerk-Entitätsberichte

* [Die [!UICONTROL Portfolio Report]](portfolio-report.md)

* [Die [!UICONTROL Search Engine Report]](search-engine-report.md)

* [Die [!UICONTROL Search Engine Account Report]](search-engine-account-report.md)

* [Die [!UICONTROL Campaign Report]](campaign-report.md)

* [Die [!UICONTROL Campaign Hourly Report]](campaign-hourly-report.md)

* [Die [!UICONTROL Ad Group Report]](ad-group-report.md)

* [Die [!UICONTROL Ad Variation Report]](ad-variation-report.md)
...
* [Die [!UICONTROL Label Classification Report]](label-classification-report.md)

* [Die [!UICONTROL Label Value Report]](label-value-report.md)

### Einschränkungsberichte

* [Die [!UICONTROL Constraint Report]](constraint-report.md)

* [Die [!UICONTROL Network Constraint Report]](network-constraint-report.md)
...
* [Die [!UICONTROL Domain Referral Report]](domain-referral-report.md)

* [Die [!UICONTROL Geo Distribution Report]](geo-distribution-report.md)

* [Die [!UICONTROL Transaction Report]](transaction-report.md)
...
>* [Berichtsspalten für einfache und erweiterte Berichte](basic-advanced-report-columns.md)
