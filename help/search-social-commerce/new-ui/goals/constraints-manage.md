...
### Anzeigen von Informationen zu Einschränkungen in der gesamten Benutzeroberfläche<!-- wording? -->
...
* [Die [!UICONTROL Constraint Report]](/help/search-social-commerce/reports/management/basic-advanced/constraint-report.md) enthält Kosten-, Klick- und (optional) Konversionsdaten für Einschränkungen, die die Architektur der Kennzeichnungsklassifizierung verwenden.
...
In der [!UICONTROL Constraints] können Sie den Status von Einschränkungen erstellen, bearbeiten und ändern.

>[!NOTE]
>
>In der entsprechenden Ansicht der Entitätsverwaltung (z. B. in der Ansicht [!UICONTROL Campaigns] für Einschränkungen auf Kampagnenebene) können Sie Gebotseinheiten Beschränkungen zuweisen und ihre Zuweisung aufheben.
