...
1. Konfigurieren Sie [Einstellungen für Konversionsregeln](#google-ads-conversion-value-rule-settings).
   ...
   Innerhalb einer Bedingung werden mehrere Ziele oder Ausschlüsse mithilfe des booleschen `OR` verbunden, sodass jede Option zum Initiieren einer Wertanpassung erfüllt sein kann. Wenn Sie eine sekundäre Bedingung einbeziehen, wird die sekundäre Bedingung mit dem booleschen Operator `ALL` mit der primären Bedingung verknüpft, sodass beide Bedingungen erfüllt sein müssen, um eine Wertanpassung zu initiieren. Beispiel: Wenn \[Standort Algerien ODER Tunesien\] UND \[Gerät ist Mobil ODER Tablet\] ist, fügen Sie 1.5 hinzu.
...
1. Klicken Sie in der Symbolleiste für Massenaktionen auf (/help/search-social-commerce/assets/edit-new.png „Bearbeiten„).
...
1. Bearbeiten Sie die [Einstellungen für Konversionsregeln](#google-ads-conversion-value-rule-settings).
   ...
   **Hinweis:** Wenn Sie eine sekundäre Bedingung hinzufügen, muss sie vom gleichen Bedingungstyp sein wie andere Regeln im Konto. Wenn beispielsweise Regel 1 oder andere Regeln im Konto die sekundäre Bedingung „Standort“ aufweisen, muss, wenn die anderen Regeln eine sekundäre Bedingung enthalten, die sekundäre Bedingung „Standort“ sein. Wenn Sie eine sekundäre Bedingung einbeziehen, wird die sekundäre Bedingung mit dem booleschen Operator `ALL` mit der primären Bedingung verknüpft, sodass beide Bedingungen erfüllt sein müssen, um eine Wertanpassung zu initiieren.
...
| | [!UICONTROL Campaign] | (Nur Konversionswertregeln auf Kampagnenebene) Die Anzeigenkampagne. |
| [!UICONTROL Conditions] > [!UICONTROL Primary Condition] | \[Bedingungstyp\] | (Schreibgeschützt für bestehende Regeln) Der Bedingungstyp, der erfüllt sein muss, damit eine Wertanpassung Trigger wird:<ul><li>*[!UICONTROL Device]:* Um alle oder bestimmte Gerätetypen auszuwählen.</li><li>*[!UICONTROL Location]:* Alle Länder und Gebiete als Ziel auswählen oder bestimmte Orte als Ziel auswählen und ausschließen.</li><li>*[!UICONTROL Audiences]:* Alle oder bestimmte Zielgruppen ansprechen</li></ul>**Hinweis:** Alle Regeln in einem Konto müssen denselben Typ von primären und (optionalen) sekundären Bedingungen verwenden. Wenn beispielsweise Regel 1 die primäre Bedingung „Zielgruppe“ und die sekundäre Bedingung „Standort“ enthält, müssen alle anderen Regeln im Konto die primäre Bedingung „Zielgruppe“ aufweisen. Wenn die anderen Regeln eine sekundäre Bedingung enthalten, muss sie „Standort“ lauten. |
| | \[Bedingungstyp\] > [!UICONTROL Device] und [!UICONTROL Device Level] | (Nur Gerätebedingungen) Welche Gerätetypen angesprochen werden sollen:<ul><li>*[!UICONTROL All devices]:** Alle Gerätetypen werden als Ziel ausgewählt.</li><li>*[!UICONTROL Select devices]:* Geben Sie einen oder mehrere Gerätetypen für das Targeting an: *[!UICONTROL Desktop]:*, *[!UICONTROL Mobile]* und *[!UICONTROL Tablet]:*.</li></ul>Innerhalb einer Bedingung werden mehrere Ziele mithilfe des booleschen `OR` verbunden, sodass jede Option zum Initiieren einer Wertanpassung erfüllt sein kann. Beispiel: Wenn \[Gerät ist Mobil ODER Tablet\], dann fügen Sie 1.5. |
| | \[Bedingungstyp\] > [!UICONTROL Location] und [!UICONTROL Location Level] | (Nur Standortbedingungen) Die Standortziele und -ausschlüsse:<ul><li>*[!UICONTROL All countries and territories]:* Um alle Länder und Standorte anzusprechen oder bestimmte Standorte anzusprechen und auszuschließen.</li><li>*[!UICONTROL Enter a location]:* Bestimmte Orte auswählen und ausschließen.</li></ul><ul><li>Um einen Speicherort oder Unterspeicherort zu erweitern, klicken Sie auf `>` nach dem Namen.</li><li>Um eine Zielgruppe hinzuzufügen, wählen Sie die Zielgruppe einmal aus, um ein grünes Häkchen anzuzeigen.</li><li>Um eine Zielgruppe auszuschließen, wählen Sie die Zielgruppe ein zweites Mal aus, um eine rote **[!UICONTROL X]** anzuzeigen.</li><li>Um eine Zielgruppe oder einen Ausschluss zu entfernen, führen Sie einen der folgenden Schritte aus:<ul><li>Klicken Sie ![Löschen](/help/search-social-commerce/assets/delete.png "Löschen") neben dem Element in der Spalte &quot;[!UICONTROL Selections]&quot;.</li><li>Wählen Sie das Ziel aus, bis kein Häkchen oder [!UICONTROL X] angezeigt wird.</li></ul></li></ul>Innerhalb einer Bedingung werden mehrere Ziele oder Ausschlüsse mithilfe des booleschen `OR` verbunden, sodass jede Option zum Initiieren einer Wertanpassung erfüllt sein kann. Beispiel: Wenn \[Standort Algerien ODER Tunesien\] ist, fügen Sie 1.5 hinzu. |
| | \[Bedingungstyp\] > [!UICONTROL Audience] und [!UICONTROL Audience Level] | (Nur Zielgruppenbedingungen) Die Zielgruppe zielt auf Folgendes ab:<ul><li>*[!UICONTROL All audience segments]:* Um alle Zielgruppensegmente [!DNL Google Ads].</li><li>*[!UICONTROL Enter audience segments]:*, um bestimmte Zielgruppensegmente [!DNL Google Ads].</li></ul><ul><li>Um eine Kategorie oder Unterkategorie in ihre Segmente zu erweitern, klicken Sie auf `>` nach dem Namen.</li><li>Um ein Ziel hinzuzufügen, wählen Sie das Ziel aus.</li><li>Um eine Zielgruppe zu entfernen, heben Sie die Auswahl der Zielgruppe auf oder klicken Sie ![Löschen](/help/search-social-commerce/assets/delete.png "Löschen") neben dem Element in der Spalte [!UICONTROL Selection].</li></ul>Innerhalb einer Bedingung werden mehrere Ziele oder Ausschlüsse mit dem booleschen Operator ODER verbunden, sodass jede Option zum Initiieren einer Wertanpassung erfüllt sein kann. Beispiel: Wenn \[Zielgruppe sind Sonderangebotsreisende ODER Familienurlauber\], dann ist 1.5.<br><br>**Hinweis:** Nachdem Sie eine Zielgruppe gespeichert haben, können Sie zusätzliche Zielgruppen hinzufügen, sie jedoch nicht außerhalb des [!DNL Google Ads]-Editors entfernen. Wenn Sie eine Zielgruppe entfernen müssen, melden Sie sich direkt bei [!DNL Google Ads] an und verwenden Sie den [!DNL Google Ads]. |
| [!UICONTROL Conditions] > [!UICONTROL Secondary Condition] | \[Bedingungstyp\] | (Optional, schreibgeschützt für bestehende Regeln) Der Bedingungstyp, der erfüllt werden muss, um eine Wertanpassung in den Trigger zu bringen. Wenn Sie eine sekundäre Bedingung einbeziehen, wird die sekundäre Bedingung mit dem booleschen Operator `ALL` mit der primären Bedingung verknüpft, sodass beide Bedingungen erfüllt sein müssen, um eine Wertanpassung zu initiieren. Beispiel: Wenn \[Standort Algerien ODER Tunesien\] UND \[Gerät ist Mobil ODER Tablet\] ist, fügen Sie 1.5.<br><br>Siehe die Einträge für primäre Bedingungen für Beschreibungen.<br><br>**Hinweis:** Alle Regeln in einem Konto müssen denselben Typ von primären und (optionalen) sekundären Bedingungen verwenden. Wenn beispielsweise Regel 1 die primäre Bedingung „Zielgruppe“ und die sekundäre Bedingung „Standort“ enthält, müssen alle anderen Regeln im Konto die primäre Bedingung „Zielgruppe“ aufweisen. Wenn die anderen Regeln eine sekundäre Bedingung enthalten, muss sie „Standort“ lauten. |
| [!UICONTROL Value Adjustment] | [!UICONTROL Adjustment Operation] und [!UICONTROL Adjustment Value] | Geben Sie den Anpassungstyp an, und geben Sie dann einen positiven Wert ein:<ul><li>*[!UICONTROL Add]:* Fügt den angegebenen Wert zum übergebenen Konversionswert hinzu. Der Wert muss größer als null (0) sein.</li><li>*[!UICONTROL Multiply]:* Multipliziert den Konversionswert, der mit dem angegebenen Wert übergeben wird. Der Wert muss zwischen 0,5 und 10 liegen.</li></ul> |
