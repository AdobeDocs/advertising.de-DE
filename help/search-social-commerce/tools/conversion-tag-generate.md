...
## (Neue Benutzeroberfläche) Generieren und Implementieren eines Conversion-Tracking-Tags in Search, Social und Commerce
...
## (veraltete Benutzeroberfläche) Erstellen und Implementieren eines Konversionsverfolgungstags in Search, Social und Commerce
...
1. Geben Sie die [Konvertierungs-Tag-Einstellungen](#conversion-tag-settings-legacy) an.
...
### Einstellungen für Adobe Advertising-Konversions-Tags {#conversion-tag-settings-legacy}
