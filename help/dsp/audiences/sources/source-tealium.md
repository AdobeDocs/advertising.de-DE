...
1. Der Werbetreibende muss Segmentzuordnungsdaten an das Adobe-Konto-Team weiterleiten, um die Segmente in DSP zu erstellen. Verwenden Sie die folgenden Spaltennamen und -werte in einer durch Kommas getrennten Wertedatei:
...
1. Fügen Sie [!DNL Tealium] [einen Connector hinzu](https://docs.tealium.com/server-side/connectors/add/) indem Sie die folgenden Optionen verwenden:
   ...
   1. Geben Sie in den Konfigurationseinstellungen den AWS-Firehose-Connector an. Wenn Sie den Feuerschlauch-Connector für DSP noch nicht hinzugefügt haben, fügen Sie einen Feuerschlauch-Connector mit den folgenden Informationen hinzu:

      * **Name:** Der Name des Connectors.

      * **Zugriffsschlüssel:** Der vom Adobe-Konto-Team bereitgestellte Zugriffsschlüssel.

      * **Geheimschlüssel:** Der vom Adobe-Konto-Team bereitgestellte geheime Schlüssel.
...
Die Segmente sollten in DSP innerhalb von 24 Stunden verfügbar sein. Nachdem DSP die Segmentdaten erhalten hat, sollte die Zielgruppengröße innerhalb von neun (9) Stunden sichtbar sein.
