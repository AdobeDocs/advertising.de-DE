...
1. [Anfordern eines Daten-Push von/ [!DNL Amperity]  DSP](#push-data).
...
## Schritt 4: Anfordern eines Daten-Push von [!DNL Amperity] an DSP {#push-data}

1. Nachdem das Segment in DSP zugeordnet wurde, muss der Advertiser mit seinem [!DNL Amperity] zusammenarbeiten, um die Segmentdaten an DSP zu verteilen.
