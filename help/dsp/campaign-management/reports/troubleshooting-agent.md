...
Die KI-gestützte [!UICONTROL Troubleshooting Agent] kann:

* Hilfe bei der Diagnose von Leistungs- und Versandproblemen für ein ausgewähltes Live-Paket oder eine ausgewählte Platzierung. Sie können nach Ausgabenproblemen (Ausbleiben von Ausgaben, niedrige Ausgaben, überhöhte Ausgaben), Pacing-Problemen (Unterschreiten, überhöhtes Tempo), Auktions- und Versandproblemen (niedrige Gebote, niedrige Gewinnrate, keine Impressionen) und Leistungsproblemen (wie Änderungen bei CPA, ROAS, CTR oder CVR) fragen.
...
### Fehlerbehebung bei Leistung und Bereitstellung
...
1. (Optional, nur allgemeine Produktfragen) Führen Sie einen der folgenden Schritte aus, um eine als Datenquelle verwendete Seite zu öffnen:
