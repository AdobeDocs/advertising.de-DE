...
|---------|-----------|-------------|----------|----------|
| [Details zum Geschäft] | [!UICONTROL Deal name] | Der Name zur Identifizierung Ihrer [!UICONTROL Deal ID] in der DSP. Benennen oder auswählen **[!UICONTROL Auto-name]** , damit DSP einen Namen basierend auf den Geschäftsdetails generieren kann.<br><br>Beispiel eines automatisch generierten Namens: `[!DNL 24159708 - Deal ID - Guaranteed Fixed - USD - 5 - 24Kitchen - Private]` | Ja | Ja |
