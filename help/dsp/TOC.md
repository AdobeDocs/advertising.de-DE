...
+ Zielgruppen-{#audiences}
   ...
   + {#sources}
      ...
      + Workflows nach Customer Data Platform-{#sources-workflows}
...
+ {#inventory}
   ...
   + {#private-inventory}
      ...
      + Angebots-IDs {#deal-ids}
         ...
         + Programmgesteuerte garantierte {#programmatic-guaranteed-deal}
            ...
            + Programmgesteuerte garantierte [!DNL FreeWheel]-Angebote {#freewheel}
...
+ {#custom-reports} benutzerdefinierter Berichte
...
+ [Kunden-Support](https://experienceleague.adobe.com/home?support-tab=home#support)
