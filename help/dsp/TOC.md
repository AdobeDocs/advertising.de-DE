...
+ Einleitung {#introduction}
   ...
   + [Unterstützung für den Verbraucherdatenschutz](https://experienceleague.adobe.com/docs/advertising/privacy/home.html)<!-- This is a duplicate link to this file, so using an absolute link here instead of a relative link. Github doesn't allow duplicate links via relative links. -->
...
+ Campaign Management {#campaign-management}
   ...
   + Kampagnen {#campaigns}
      ...
      + [Anhalten oder Aktivieren einer Kampagne](/help/dsp/campaign-management/campaigns/campaign-pause-activate.md)
   ...
   + Platzierungen {#placements}
      ...
      + [Bearbeiten einer Platzierung](/help/dsp/campaign-management/placements/placement-edit.md)
      + [Schnelles Bearbeiten der wichtigsten Platzierungseinstellungen](/help/dsp/campaign-management/placements/placement-quick-edit.md)
      + [Duplizieren einer Platzierung](/help/dsp/campaign-management/placements/placement-duplicate.md)
   ...
   + Anzeigen {#ads}
      ...
      + [Hinzufügen von Anzeigen zu Platzierungen](https://experienceleague.adobe.com/docs/advertising/dsp/campaign-management/placements/ad-attach-to-placement.html)<!-- Dupe link to this file (in Placements chapter), so need to use an absolute link in one of the listings -->
   ...
   + Leistungsberichte in Campaign Management-Ansichten {#campaign-reports}
      ...
      + [Anzeigen der Sites, Anzeigen, Häufigkeit und Inventardetails für eine Platzierung](/help/dsp/campaign-management/reports/placement-details-view.md)
   ...
   + Korrigieren von Platzierungseinstellungen mithilfe von Kalkulationstabellen {#qa-spreadsheet}
      + [Wissenswertes über das Korrigieren von Platzierungseinstellungen mithilfe von Kalkulationstabellen](/help/dsp/campaign-management/qa/qa-about.md)
      + [Herunterladen von Platzierungseinstellungen in einer Tabelle](/help/dsp/campaign-management/qa/qa-sheet-download.md)
      + [Hochladen von Platzierungseinstellungen in eine Tabelle](/help/dsp/campaign-management/qa/qa-sheet-upload.md)
...
+ Optimierung {#optimization}
   + [Wie [!DNL DSP] Optimiert Ihre Kampagnen](/help/dsp/optimization/optimization-how-dsp-optimizes-campaigns.md)
...
+ Zielgruppen {#audiences}
   ...
   + Quellen {#sources}
      + [Informationen zum Aktivieren authentifizierter Segmente aus Zielgruppenquellen](/help/dsp/audiences/sources/source-about.md)
      + Workflows nach Kundendatenplattform {#sources-workflows}
         + [!DNL Adobe Real-Time CDP] {#sources-adobe-rt-cdp}
            ...
            + [Aktivieren authentifizierter Segmente von universellen ID-Partnern](/help/dsp/audiences/sources/source-universal-id.md)
         + [Workflow für die Verwendung der DSP-Integration mit [!DNL Tealium]](/help/dsp/audiences/sources/source-tealium.md)
      + [Erstellen einer Zielgruppenquelle zum Aktivieren von Erstanbieter-Zielgruppen](/help/dsp/audiences/sources/source-create.md)
...
+ Inventar {#inventory}
   ...
   + [!DNL On Demand] Inventar {#on-demand}
      + [Info [!DNL On Demand] Prämienbestand](/help/dsp/inventory/on-demand-inventory-about.md)
      + Verfügbar [!DNL On Demand] Premium Inventory Publishers {#publishers}
         ...
         + [[!DNL On Demand] Premium Inventory Publisher in Australien und Neuseeland](/help/dsp/inventory/on-demand-inventory-publishers-anz.md)
      ...
      + [Abonnieren und Zugriff anfordern auf [!DNL On Demand] Premium-Inventarangebote](/help/dsp/inventory/on-demand-inventory-subscribe.md)
      + [Erneut anfordern [!DNL On Demand] Premium-Inventarangebote](/help/dsp/inventory/on-demand-inventory-rerequest.md)
      + [Status Ihres s anzeigen [!DNL On Demand] Abschlussanfragen und Abonnements](/help/dsp/inventory/on-demand-inventory-view-status.md)
   + Privatinventar {#private-inventory}
      ...
      + Angebots-IDs {#deal-ids}
         + [!UICONTROL Deal ID Inbox] {#inbox}
            ...
            + [Akzeptieren eines Deals in der [!UICONTROL Deal ID Inbox]](/help/dsp/inventory/deal-id-inbox-accept.md)
         ...
         + Programmgesteuerte garantierte -Angebote {#programmatic-guaranteed-deal}
            ...
            + [!DNL FreeWheel] Programmgesteuerte garantierte -Angebote {#freewheel}
               ...
               + [Überprüfen des Status der Anzeigen auf [!DNL FreeWheel] Programmgesteuerte garantierte -Angebote](/help/dsp/inventory/freewheel-check-status.md)
      ...
      + [Angeben von Platzierungen und Anzeigen für ein privates Angebot](/help/dsp/inventory/deal-id-attach-placements.md)
      + [Bearbeiten der Konten mit Zugriff auf einen privaten Abschluss](/help/dsp/inventory/deal-id-share.md)
      + [Bearbeiten der Werbetreibenden mit Zugriff auf ein privates Angebot](/help/dsp/inventory/deal-id-edit-advertisers.md)
   ...
   + [!UICONTROL Simple Ad Serving] Angebote {#sas}
      ...
      + [Erstellen eines [!UICONTROL Simple Ad Serving] Geschäft](/help/dsp/inventory/simple-deal-create.md)
   ...
   + [Detaillierten Bericht für einen Abschluss anzeigen](/help/dsp/inventory/deal-view-report.md)
+ Benutzerdefinierte Berichte {#custom-reports}
   ...
   + [Löschen eines benutzerdefinierten Berichts](/help/dsp/reports/report-delete.md)
   + [Benutzerdefinierten Bericht ausführen](/help/dsp/reports/report-run-now.md)
   + [Benutzerdefinierte Berichtseinstellungen](/help/dsp/reports/report-settings.md)
   + [Verfügbare Berichtsspalten](/help/dsp/reports/report-columns.md)
   + [Häufig gestellte Fragen zu Haushaltsberichten](/help/dsp/reports/faq-household-report.md)
   + Berichtsziele {#report-destinations}
      ...
      + [Bearbeiten einer Datei [!UICONTROL Report Destination]](/help/dsp/reports/report-destinations/report-destination-edit.md)
...
+ Planer {#planner}
   ...
   + [Erstellen eines Plans für die Connected TV-Reichweite](/help/dsp/planner/planner-create.md)
   + [Duplizieren eines Verbindungs-TV-Reach-Plans](/help/dsp/planner/planner-duplicate.md)
   + [Bearbeiten eines Connected TV Reach-Plans](/help/dsp/planner/planner-edit.md)
...
+ Administration {#admin}
   ...
   + Benutzer {#users}
      ...
      + [Einladen eines ausstehenden Benutzers aufheben](/help/dsp/admin/user-uninvite.md)
   + Blockierte Websites {#sites}
      + [Über die Blockierungslisten auf Konto- und Werbekunden-Ebene](/help/dsp/admin/blocked-sites-list-about.md)
...
+ [Kunden-Support](https://helpx.adobe.com/de/contact/enterprise-support.ec.html)
