...
Betrachten Sie das folgende Beispiel einer Cross-Visit-Journey. Jeder Besuch auf Ihrer Website wird durch den Marketing-Kanal angezeigt, über den der Besucher eingetreten ist. Der erste Besuch, auch als Erstkontakt-Kanal bezeichnet, ist E-Mail. Display on Visit Two ist ein teilnehmender Kanal und die natürliche Suche gilt als Letztkontakt-Kanal. Wenn Sie [!UICONTROL Last Touch Attribution] in [!UICONTROL Attribution IQ] verwenden, wird Natural Search das Konversionsereignis im Wert von 250 $ vollständig gutgeschrieben. Mithilfe des Experience Cloud ID-Service können Sie diese individuellen Besuche miteinander verknüpfen, um eine Journey durch einen einzelnen Besucher anzuzeigen.
